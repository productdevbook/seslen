...
const BUDGETS = [
  // Core grew to absorb bus / voice-cap / throttle / jitter / fade / pan /
  // sprite / persist / render / analyser / reduced-motion. Gzip ≈ 1/3.
  { glob: /^index\.mjs$/, max: 12288, label: "core" },
  { glob: /^presets\/index\.mjs$/, max: 8192, label: "presets:index" },
  { glob: /^presets\/.+\.mjs$/, max: 2048, label: "presets:entry" },
  { glob: /^server\.mjs$/, max: 2048, label: "server" },
]
